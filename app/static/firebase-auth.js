(() => {
  ...
  // frontend/node_modules/@firebase/util/dist/postinstall.mjs
  ...
  // frontend/node_modules/@firebase/util/dist/index.esm.js
  function getGlobal() {
  ...
  // frontend/node_modules/@firebase/component/dist/esm/index.esm.js
  ...
  // frontend/node_modules/@firebase/logger/dist/esm/index.esm.js
  ...
  // frontend/node_modules/idb/build/wrap-idb-value.js
  ...
  // frontend/node_modules/idb/build/index.js
  ...
  // frontend/node_modules/@firebase/app/dist/esm/index.esm.js
  ...
  // frontend/node_modules/@firebase/installations/dist/esm/index.esm.js
  ...
  var name3, version3, PENDING_TIMEOUT_MS, PACKAGE_VERSION, INTERNAL_AUTH_VERSION, INSTALLATIONS_API_URL, TOKEN_EXPIRATION_BUFFER, SERVICE, SERVICE_NAME, ERROR_DESCRIPTION_MAP, ERROR_FACTORY2, VALID_FID_PATTERN, INVALID_FID, fidChangeCallbacks, broadcastChannel, DATABASE_NAME, DATABASE_VERSION, OBJECT_STORE_NAME, dbPromise2, INSTALLATIONS_NAME, INSTALLATIONS_NAME_INTERNAL, publicFactory, internalFactory;
  ...
  // frontend/node_modules/@firebase/analytics/dist/esm/index.esm.js
  ...
  var ANALYTICS_TYPE, GA_FID_KEY, ORIGIN_KEY, FETCH_TIMEOUT_MILLIS, DYNAMIC_CONFIG_URL, GTAG_URL, logger2, ERRORS2, ERROR_FACTORY3, LONG_RETRY_FACTOR, BASE_INTERVAL_MILLIS, RetryData, defaultRetryData, AnalyticsAbortSignal, defaultEventParametersForInit, defaultConsentSettingsForInit, AnalyticsService, initializationPromisesMap, dynamicConfigPromisesList, measurementIdToAppId, dataLayerName, gtagName, gtagCoreFunction, wrappedGtagFunction, globalInitDone, name4, version4;
  ...
  // frontend/node_modules/@firebase/auth/dist/esm/index-dfb5c973.js
  ...
  // frontend/node_modules/@firebase/auth/dist/esm/index.js
  var init_esm = __esm({
    "frontend/node_modules/@firebase/auth/dist/esm/index.js"() {
      init_index_dfb5c973();
      init_index_esm4();
  ...
  // frontend/node_modules/firebase/auth/dist/esm/index.esm.js
      ...
      async function loadBillingWidget() {
        ...
        try {
          ...
          if (cached) {
            ...
            $("usageSummary").textContent = `Documents: ${cachedDocs} | Billed: ${formatRand(cachedBilled)} | Limit: ${formatRand(cachedLimit)} (${cachedPct}%)`;
            return;
          }
          ...
          $("usageSummary").textContent = `Documents: ${documents} | Billed: ${formatRand(billed)} | Limit: ${formatRand(limit)} (${pct}%)`;
        } catch (_err) {
          $("usageSummary").textContent = "Billing summary unavailable.";
        }
      }
